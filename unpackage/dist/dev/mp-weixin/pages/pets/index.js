...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const dogList = common_vendor.ref([
      {
    ...
    const catList = common_vendor.ref([
      {
    ...
    const getStorage = () => {
      ...
      if (typeof common_vendor.index !== "undefined") {
        const {
          key
        } = common_vendor.index.getStorageSync("petTabKey");
        const currentKey = ((_a = navList.value.find((item) => item.id === key)) == null ? void 0 : _a.key) || 0;
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: common_vendor.f(common_vendor.unref(navList), (item, index, i0) => {
          return {
            a: common_vendor.t(item.title),
            b: item.id,
            c: common_vendor.unref(currentIndex) === index ? 1 : "",
            d: common_vendor.o(($event) => onClickItem(index), item.id)
          };
        }),
        b: !common_vendor.unref(currentIndex)
      }, !common_vendor.unref(currentIndex) ? {
        c: common_vendor.p({
          list: catList.value
        })
      } : {}, {
        d: common_vendor.unref(currentIndex)
      }, common_vendor.unref(currentIndex) ? {
        e: common_vendor.p({
          list: dogList.value
        })
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-b5bd9a22"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/pets/index.js.map
