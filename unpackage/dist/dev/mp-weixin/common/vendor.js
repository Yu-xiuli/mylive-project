...
function initRuntimeSocketService() {
  const hosts = "192.168.31.65,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_ZGPeTQ";
  ...
  list: [
    {
      ...
      selectedIconPath: "/static/主页_active.png",
      text: "首页"
    },
    {
      pagePath: "pages/pets/index",
      iconPath: "/static/宠物.png",
      selectedIconPath: "/static/宠物_active.png",
      text: "爱宠"
    },
    {
      pagePath: "pages/travel/index",
      iconPath: "/static/旅行.png",
      selectedIconPath: "/static/旅行_active.png",
      text: "旅行"
    },
    {
      pagePath: "pages/userconf/index",
      iconPath: "/static/我的.png",
      selectedIconPath: "/static/我的_active.png",
      text: "我的"
    }
  ]
};
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.31.65"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","E:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"my-happy-live-serve","spaceId":"mp-0a90efc1-6fba-4a2d-b3ee-e9fd012734b2","clientSecret":"TZOK9jSoiolMT5/29ybPtA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__F497F95";
} catch (e2) {
